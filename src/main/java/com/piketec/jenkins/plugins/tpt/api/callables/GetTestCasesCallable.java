...
/**
 * This Callable returns a list of all testcase for the given parameters. The code is run on a Jenkins Agent and uses
 * the TPT API. 
 */
public class GetTestCasesCallable extends TptApiCallable<Collection<String>> {
	...
	public GetTestCasesCallable(TaskListener listener, String hostName, int tptPort, String tptBindingName,
